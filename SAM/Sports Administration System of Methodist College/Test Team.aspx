<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Test Team.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Test_Team" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class= "section-title">Basketball Team Selection</h2>
            </div>
        </div>
   ...
   <div class="row">
       ...
       <div class="col-3">
           <asp:GridView ID="GridView2" 
               ...
               runat="server" RowStyle-Height="84" OnSorting="GridView2_Sorting"> 
                         
       </asp:GridView>
       </div>
            
                     <div class="col-9">
                         <asp:GridView runat="server" AutoGenerateColumns="False" ID ="GridView1" class="table table-striped table table-bordered" Width="850px" OnRowDataBound="GridView1_RowDataBound" OnSorting="GridView1_Sorting" OnRowCommand="GridView1_RowCommand"> 
