...
{
    public partial class adminParticipantarchery : System.Web.UI.Page
    {
        ...
        private void GetData(string searchText = "")
        {
            ...
            {
                qry = "Select * from Student_Sport where SportName='Archery'";
            }
            else
            {
                qry = "Select * from Student_Sport where SportName= 'Archery' AND FirstName like '%" + searchText + "%'";
            }
        ...
        //        SqlCommand cmd = new SqlCommand("SELECT * FROM Student_Sport where Sport_Name='Archery'", con);
        ...
        //    }
        //}
        //protected void Button1_Click1(object sender, EventArgs e)//emails
        //{
        //    getemail();
        //}
        ...
        protected void Button1_Click(object sender, EventArgs e)//cancel alert
        {
            try
            {
                SqlConnection con = new SqlConnection(strcon);
                con.Open();
                SqlCommand cmd = new SqlCommand("select Email,FirstName, Surname from Student_Sport where SportName= 'Archery' ", con);
                ...
                while (dr.Read())
                {
                    ...
                    string message = "Archery practices have been cancelled. Please check the practice schedules for more information.";
                    MailMessage msg = new MailMessage();
                    msg.To.Add(add);
                    msg.From = addr;
