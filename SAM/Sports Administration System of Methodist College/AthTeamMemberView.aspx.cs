...
{
    public partial class AthTeamMemberView : System.Web.UI.Page
    {
        ...
        private void GetData(string dropdownText = "")
        {
            ...
            {
                qry = "Select * from Student_Team where TeamName= 'AthU18' OR TeamName = 'AthU16' OR TeamName = 'AthU14' OR TeamName = 'AthU12' OR TeamName = 'AthU20'";
            }
            else
            {
        ...
        protected void teamname()
        {
            ...
            SqlCommand cmd1 = new SqlCommand("Select Distinct TeamName from Student_Team Where TeamName= 'AthU12' OR TeamName= 'AthU14' OR TeamName='AthU16' OR TeamName='AthU18' OR TeamName='AthU20'", con);
            // table name   
