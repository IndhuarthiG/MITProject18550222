<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="coach view archery Participants.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.coach_view_archery_Participants" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-title">Archery Participants
                    </h2>
                </div>
            </div>
            ...
            <div class="row">
                <asp:SqlDataSource ID="SqlDataSource1"
                    ...
                    <SelectParameters>
                        <asp:QueryStringParameter DefaultValue="Archery"
                            Name="SportName"
                            QueryStringField="SportName = Archery"
                            Type="String" />
                    </SelectParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="AdmissionNo"
