<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="coach view TT Participants.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.coach_view_TT_Participants" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-title">Table Tennis Participants
                    </h2>
                </div>
            </div>
            ...
            <div class="row">
                <asp:SqlDataSource ID="SqlDataSource1"
                    ...
                    SelectCommand="SELECT [ID], [AdmissionNo], [FirstName], [Surname], [Sport_Name], [Email] FROM [Student_Sport] WHERE ([Sport_Name] = @Sport_Name)"
                    ConflictDetection="CompareAllValues"
                    DeleteCommand="DELETE FROM [Student_Sport] WHERE [ID] = @original_ID AND [AdmissionNo] = @original_AdmissionNo AND [FirstName] = @original_FirstName AND [Surname] = @original_Surname AND [Sport_Name] = @original_Sport_Name AND [Email] = @original_Email"
                    InsertCommand="INSERT INTO [Student_Sport] ([AdmissionNo], [FirstName], [Surname], [Sport_Name], [Email]) VALUES (@AdmissionNo, @FirstName, @Surname, @Sport_Name, @Email)"
                    OldValuesParameterFormatString="original_{0}"
                    UpdateCommand="UPDATE [Student_Sport] SET [AdmissionNo] = @AdmissionNo, [FirstName] = @FirstName, [Surname] = @Surname, [Sport_Name] = @Sport_Name, [Email] = @Email WHERE [ID] = @original_ID AND [AdmissionNo] = @original_AdmissionNo AND [FirstName] = @original_FirstName AND [Surname] = @original_Surname AND [Sport_Name] = @original_Sport_Name AND [Email] = @original_Email">
                    ...
                    <DeleteParameters>
                        ...
                        <asp:Parameter Name="original_Surname"
                            Type="String" />
                        <asp:Parameter Name="original_Sport_Name"
                            Type="String" />
                    ...
                    <InsertParameters>
                        ...
                        <asp:Parameter Name="Surname"
                            Type="String" />
                        <asp:Parameter Name="Sport_Name"
                            Type="String" />
                        <asp:Parameter Name="Email"
                            Type="String" />
                    </InsertParameters>
                    <SelectParameters>
                        <asp:QueryStringParameter DefaultValue="Table Tennis"
                            Name="Sport_Name"
                            QueryStringField="Sport_Name = Table Tennis"
                            Type="String" />
                    </SelectParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="AdmissionNo"
