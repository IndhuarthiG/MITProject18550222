<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminMatches.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.adminMatches" %>
...
<!--Start of main content-->
    <div class="main" aria-setsize="2000">
        <h2 style="color: #008080">Matches Table</h2>
    <br />
    <br />
    <br />
        ...
        <div class="container">
            ...
            <asp:GridView ID="GridView1" 
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Match_ID" 
                        InsertVisible="False" 
                        SortExpression="Match_ID" 
                        Visible="False">
                        <EditItemTemplate>
                            <asp:Label ID="Label1" runat="server" 
                                Text='<%# Eval("Match_ID") %>'></asp:Label>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="Label1" runat="server" 
                                Text='<%# Bind("Match_ID") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Date" 
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox4" 
                                runat="server" 
                                Text='<%# Bind("Date", "{0:MM/dd/yyyy}") %>' Height="100" Width="140" CssClass="form-control"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Time" 
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox5" 
                                runat="server" 
                                Text='<%# Bind("Time") %>' Height="100" Width="150" CssClass="form-control"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Venue" 
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox6" 
                                runat="server" 
                                Text='<%# Bind("Venue") %>' TextMode="MultiLine" Height="100" Width="150" CssClass="form-control"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
