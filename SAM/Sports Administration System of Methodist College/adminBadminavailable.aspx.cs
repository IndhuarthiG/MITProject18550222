...
{
    public partial class adminBadminavailable : System.Web.UI.Page
    {
        ...
        private void GetData(string searchText = "")
        {
            ...
            string myquery = "Select * from Rosters where SportName='Badminton' AND Date='' AND Time=''";
        ...
        protected void Button2_Click(object sender, EventArgs e)//go to badminton page
        {
