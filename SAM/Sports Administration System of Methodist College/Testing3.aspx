<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Testing3.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Testing3" %>
       ...
       <script type="text/javascript">
           ...
           function getme() {
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <asp:Button ID="Button3" runat="server" Text="Practice Cancelled"/>  
                </div>
