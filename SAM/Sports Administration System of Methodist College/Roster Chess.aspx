<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Roster Chess.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Chess_Roster" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 style="color:#9900CC" class= "section-title">Chess Roster for the Month</h2>
            </div>
        </div>
                      ...
                      <asp:SqlDataSource ID="SqlDataSource1" 
                          ...
                          <SelectParameters>
                              <asp:QueryStringParameter DefaultValue="Chess" 
                                  Name="SportName" 
                                  QueryStringField="SportName=Chess" 
                                  Type="String" />
                          </SelectParameters>
                          <UpdateParameters>
                              <asp:Parameter Name="SportName" 
