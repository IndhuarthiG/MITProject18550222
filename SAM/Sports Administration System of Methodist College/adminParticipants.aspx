<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminParticipants.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.adminParticipants" %>
...
<!--Start of main content-->
    <div class="main" aria-setsize="2000">
        <h2 style="color: #008080">Participants</h2>
                         ...
                         <div class="row">
                             <div class="d-grid gap-2 col-3 mx-auto">
                                 <asp:ImageButton ID="Archery" 
                                     runat="server" 
                                     ImageUrl="~/image buttons/Parchery.png" 
                             ...
                             <div class="d-grid gap-2 col-3 mx-auto">
                                 <asp:ImageButton ID="Athletics" 
                                     runat="server" 
                                     ImageUrl="~/image buttons/Pathletics.png" 
                                     Height="150" Width="150" 
                                     ImageAlign="Middle" 
                                     ToolTip="Athletics" 
                             ...
                             <div class="d-grid gap-2 col-3 mx-auto">
                                 <asp:ImageButton ID="Badminton" 
                                     ...
                                     ImageUrl="~/image buttons/Pbadminton.png" 
                                     Height="150" Width="150" 
                                     ToolTip="Badminton" 
                             ...
                             <div class="d-grid gap-2 col-3 mx-auto">
                                  <asp:ImageButton ID="BB" runat="server" 
                                      ImageAlign="Middle" 
                                      ImageUrl="~/image buttons/PBB.png" 
                                      Height="150" Width="150" 
                                      ToolTip="Basketball"
                                      OnClick="BB_Click" />
                         ...
                         <div class="row">
                             <div class="d-grid gap-2 col-3 mx-auto">
                                 <asp:ImageButton ID="Chess" 
                                     ...
                                     ImageUrl="~/image buttons/PChess.png" 
                                     Height="120" Width="120"
                                     ToolTip="Chess" OnClick="Chess_Click" /> 
                             ...
                             <div class="d-grid gap-2 col-3 mx-auto">
                                 <asp:ImageButton ID="NB" runat="server" 
                                     ImageAlign="Middle" 
                                     ImageUrl="~/image buttons/PNB.png" ToolTip="Netball" 
                             ...
                             <div class="d-grid gap-2 col-3 mx-auto">
                                 <asp:ImageButton ID="Squash" 
                                     runat="server" ImageAlign="Middle" 
                                     ImageUrl="~/image buttons/PSquash.png" 
                                     Height="150" Width="150" 
                                     ToolTip="Squash" 
                             ...
                             <div class="d-grid gap-2 col-3 mx-auto">
                                 <asp:ImageButton ID="Swimming" 
                                     runat="server" ImageAlign="Middle" 
                                     ImageUrl="~/image buttons/PSwimming.png" 
                         ...
                         <div class="row">
                             <div class="d-grid gap-2 col-4 mx-auto">
                                 <asp:ImageButton ID="Tennis" 
                                     runat="server" ImageAlign="Middle" 
                                     ImageUrl="~/image buttons/PTennis.png" 
                             ...
                             <div class="d-grid gap-2 col-4 mx-auto">
                                 <asp:ImageButton ID="TT" runat="server" 
                                     ImageAlign="Middle" 
                                     ImageUrl="~/image buttons/PTT.png" 
                                     Height="150" Width="151" 
                             ...
                             <div class="d-grid gap-2 col-4 mx-auto">
                                 <asp:ImageButton ID="VB" runat="server" 
                                     ImageAlign="Middle" 
                                     ImageUrl="~/image buttons/PVB.png" 
