<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CoachBBteammembers.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.CoachBBteammembers" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">ript>
</asp:Content>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class= "section-title">Basketball Team Members</h2>
            </div>
        </div>
       <br />
        <div class ="row">
