...
{
    public partial class coach_view_Squah_Participants : System.Web.UI.Page
    {
        ...
        void getemail()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * FROM Student_Sport where SportName='Squash'", con);
