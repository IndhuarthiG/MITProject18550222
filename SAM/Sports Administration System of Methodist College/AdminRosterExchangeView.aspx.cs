...
{
    public partial class AdminRosterExchangeView : System.Web.UI.Page
    {
        ...
        private void GetData(string searchText = "")
        {
            ...
            {
                qry = "Select Rosters.Date As ForDate, Requests.SportName, Rosters.FirstName As RosteredTeacherName, Requests.ReStatus As Response,Requests.ReqFirstName As ReqestedTeacher, Requests.ExchangeWith FROM Requests JOIN Rosters ON Rosters.ID = Requests.ID; ";
            }
            else
            {
                qry = "Select * from Requests where SportName like '%" + searchText + "%'";
            }
        ...
        protected void Button2_Click(object sender, EventArgs e)//Reports
        {
