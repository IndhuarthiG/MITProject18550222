<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Roster Netball.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Netball" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="server">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 style="color:#9900CC" class= "section-title">Netball Roster for the Month</h2>
            </div>
        </div>
   ...
   <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource1" 
                          ...
                          <SelectParameters>
                              <asp:QueryStringParameter DefaultValue="Netball" 
                                  Name="SportName" 
                                  QueryStringField="SportName=Netball" 
                                  Type="String" />
                          </SelectParameters>
                          <UpdateParameters>
                              <asp:Parameter Name="SportName" 
