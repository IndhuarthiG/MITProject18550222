<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Student applications.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Student_applications" %>
...
<head runat="server">
  ...
  <meta charset="utf-8">
  <title>Admin Student Applications View</title>
...
<div class="main">
    <h2 style="color: #008080">Applicants List
        </h2>
        <br />
        <br />
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="d-grid gap-2 col-3 mx-auto">
                        <asp:Button ID="Button2" 
                              ...
                              runat="server" Text="Go to Reports" OnClick ="Button2_Click" /> 
            ...
            <asp:GridView ID="GridView1" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="CurrentPosition" 
                        SortExpression="CurrentPosition">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox6" 
                                runat="server" 
                                Text='<%# Bind("CurrentPosition") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="ApplyingPosition" 
                        SortExpression="ApplyingPosition">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox7" 
                                runat="server" 
                                Text='<%# Bind("ApplyingPosition") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
