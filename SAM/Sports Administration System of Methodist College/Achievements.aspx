<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Achievements.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Achievements" %>
...
<!--Start of main content-->
    <div class="main" aria-setsize="2000">
        <h2 style="color: #008080">Student Achievements</h2>
    <br />
    <br />
    <br />
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="d-grid gap-2 col-3 mx-auto">
                        <asp:Button ID="Button2" 
                              ...
                              Height="50px" 
                             Width="150px" UseSubmitBehavior="False" OnClick="Button2_Click" OnClientClick="target ='_blank';"/> 
            ...
            <asp:GridView ID="GridView1" 
                ...
                Font-Names="Poppins" 
                ForeColor="#336666" 
                DataKeyNames="AdmissionNo" OnPageIndexChanging="GridView1_PageIndexChanging" OnSorting="GridView1_Sorting">
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:Button CommandName="Select" CssClass="btn btn-primary" runat="server" Text="View" OnCommand="Unnamed_Command"/>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
