<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Test 4.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Test_4" %>
...
<head runat="server">
  ...
  <meta charset="utf-8"/>
  <title>Admin Athletics Roster</title>
...
<div class="main">
    <h2 style="color: #008080"> Athletics Roster
        </h2>
        <br />
        <br />
    <form id="form1" runat="server">
       ...
       <script type="text/javascript">
           ...
           function getme() {
            ...
            <div class="gvWidthHight">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Teacher_ID" 
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox3" 
                                runat="server" 
                                Text='<%# Bind("Teacher_ID") %>' Width="100px" Height="40px" CssClass="form-control"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Title" 
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox4" 
                                runat="server" 
                                Text='<%# Bind("Title") %>' Width="60px" Height="40px" CssClass="form-control"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Surname" 
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox5" 
                                runat="server" 
                                Text='<%# Bind("Surname") %>' Width="200px" Height="40px" CssClass="form-control"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="EmailID" 
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox7" 
                                runat="server" 
                                Text='<%# Bind("EmailID") %>' Width="180px" Height="40px" CssClass="form-control"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:BoundField DataField="Sport_ID" 
                        ...
                        Visible="False" />
                    <asp:BoundField DataField="Sport_Name" 
                        HeaderText="Sport_Name" 
                        SortExpression="Sport_Name" 
                        Visible="False" />
                    ...
                    <asp:TemplateField HeaderText="Requests" 
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox9" 
                                runat="server" 
                                Text='<%# Bind("Requests") %>' Width="100px" Height="40px" ReadOnly="True" CssClass="form-control"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Addedby" 
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox10" 
                                runat="server" 
                                Text='<%# Bind("Addedby") %>' Width="100px" Height="40px" ReadOnly="True" CssClass="form-control"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
            ...
            <div class="row">
                <div class="col-4">
                    <asp:Button ID="btnSendMail" runat="server" Text="Send Email"/>  
                </div>
                ...
                <div class="col-4">
                    <asp:Button ID="Button3" runat="server" Text="Practice Cancelled" OnClick="Button3_Click"/>  
                </div>
