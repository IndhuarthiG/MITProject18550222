<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add Invenory.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Add_Invenory" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <h2 style="color: #008080">Add Inventory</h2>
                        </center>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        <label style='font-family: Poppins; font-size: large; font-weight: normal;'>Inventory Name</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Inventory Name" Height="60"></asp:TextBox>
                      ...
                      <div class="col-md-3">
                        <label style='font-family: Poppins; font-size: large; font-weight: normal;'>Colour</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox8" runat="server" placeholder="Colour" Height="60"></asp:TextBox>
                      ...
                      <div class="col-md-2">
                        <label style="font-family: Poppins; font-size: large; font-weight: normal;">No in Stock</label>
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="No in Stock"></asp:TextBox>
