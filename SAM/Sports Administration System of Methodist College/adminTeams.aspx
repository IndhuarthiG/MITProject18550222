<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminTeams.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.adminTeams" %>
...
<div class="main">
    <h2 style="color: #008080">Teams Table</h2>
    <br />
    <br />
    <br />
        ...
        <div class="container">
            ...
            <asp:GridView ID="GridView1" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Age Category" 
                        SortExpression="AgeCategory">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox2" 
                                runat="server" 
                                Text='<%# Bind("AgeCategory") %>' Width="200" CssClass="form-control"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="Label3" runat="server" 
                                Text='<%# Bind("AgeCategory") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Edit">
                        <EditItemTemplate>
                            ...
                            <asp:ImageButton ID="Update" runat="server" ImageUrl="~/adminimages/Save-PNG-Images-HD.png" Height="45" Width="45" CommandName="Update" />&nbsp
                            <asp:ImageButton ID="Cancel" runat="server" ImageUrl="~/adminimages/Cancel.png" Height="40" Width="40" CommandName="Cancel" />
                        </EditItemTemplate>
                        <ItemTemplate>
                            <%--<asp:LinkButton ID="LinkButton1" 
                                runat="server" CausesValidation="False" 
                            ...
                            <asp:ImageButton ID="Edit" runat="server" ImageUrl="~/adminimages/edit-icon-png-3601.png" Height="45" Width="45" CommandName="Edit" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Delete">
                        <ItemTemplate>
                            <asp:ImageButton ID="Delete" runat="server" ImageUrl="~/adminimages/delete.png" Height="40" Width="40" CommandName="Delete" OnClientClick='return confirm("Delete Team?");' />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
