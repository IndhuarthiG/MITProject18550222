<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add new Team.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Add_new_Team" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <h2 style="color: #008080">Add New Team</h2>
                        </center>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-md-4">
                        <label style="font-family: Poppins; font-size: large; font-weight: normal;">Team Name</label>
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" Height="60" width="200" placeholder="Team Name"></asp:TextBox>
                               <asp:RequiredFieldValidator ID="RequiredFieldValidator1" 
                                   runat="server" 
                                   ErrorMessage="Team Name is a valid field name" 
                      ...
                      <div class="col-md-4">
                        <label style="font-family: Poppins; font-size: large; font-weight: normal;">Age category</label>
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DropDownList1" runat="server" Height="60">
                                    <asp:ListItem Text="Select" Value="Select" />
                                    <asp:ListItem Text="Under 12" Value="Under 12"/>
                                    <asp:ListItem Text="Under 14" Value="Under 14" />
                                    <asp:ListItem Text="Under 16" Value="Under 16" />
                                    <asp:ListItem Text="Under 18" Value="Under 18" />
                                    <asp:ListItem Text="Under 20" Value="Under 20" />
                           </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2"
                                runat="server" 
                                ErrorMessage="Age Category is a valid field name" 
