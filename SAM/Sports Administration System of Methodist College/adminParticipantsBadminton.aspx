<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminParticipantsBadminton.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.adminParticipantsBadminton" %>
...
<head runat="server">
  ...
  <meta charset="utf-8"/>
  <title>Admin Badminton Participants</title>
...
<div class="main">
    <h2 style="color: #008080"> Badminton Participants
        </h2>
        <br />
        <br />
                    ...
                    <div class="row">
                        ...
                        <div class="d-grid gap-2 col-6 mx-auto text-right">
                            <asp:Button ID="Button3"
                                ...
                                Height="50px"
                                Width="150px" OnClick="Button3_Click1"
                                UseSubmitBehavior="False"/>
