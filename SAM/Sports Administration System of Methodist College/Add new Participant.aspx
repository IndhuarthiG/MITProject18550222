<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add new Participant.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Add_new_Participant" %>
...
<head runat="server">
  ...
  <meta charset="utf-8">
  <title>Admin Add Participant</title>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <h2 style="color: #008080">Add New Participant</h2>
                        </center>
                     </div>
                  </div>
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Admission No" Height="60"></asp:TextBox>
