...
{
    public partial class Badminton_Roster : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from Rosters where Teacher_ID='" + Session["UserName"].ToString() + "' AND SportName='Badminton'", con);
        ...
        protected bool CheckEnabled(String _email, String _teacherID)
        {
            ...
            SqlCommand cmd = new SqlCommand("select count(*) from Rosters where Teacher_ID='" + _teacherID + "' AND SportName='Badminton' AND Requests!=''", con);
        ...
        //protected void LinkButton1_Click1(object sender, CommandEventArgs e )
        //{
        //    try
        //    {
        ...
        //        SqlCommand cmd = new SqlCommand("Update Rosters Set Requests = 'Requested', Addedby= '" + Session["UserName"].ToString() + "', ExchangeWith='" + this.DropDownList3.SelectedItem.Text + "' where ID=" + id, con);
