<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminQueryview.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.adminQueryview" %>
...
<div class="main">
    <h2 style="color: #008080">Messages List
        </h2>
        <br />
        <br />
    <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:GridView ID="GridView1" 
                ...
                Font-Names="Poppins" 
                Width="1000px" AutoGenerateSelectButton="True">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Message" 
                        ...
                        <ItemTemplate>
                            <asp:Label ID="Label5" runat="server" 
                                Text='<%# Bind("Message") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Delete">
                        <ItemTemplate>
                            <asp:ImageButton ID="Delete" runat="server" ImageUrl="~/adminimages/delete.png" Height="40" Width="40" CommandName="Delete" OnClientClick='return confirm("Delete This Message?");' />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
