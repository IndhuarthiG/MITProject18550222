<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Schedule BB.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Schedule_BB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="server">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 style="color:#339966" class= "section-title">Basketball Schedule for the Week</h2>
            </div>
        </div>
   ...
   <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource1" 
                          ...
                          SelectCommand="SELECT [ID], [Sport_ID], [SportName], [Date], [Time], [Status] FROM [Rosters] WHERE ([SportName] = @SportName)" 
