<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminArchAvail.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.adminArchAvail" %>
...
<head runat="server">
  ...
  <meta charset="utf-8"/>
  <title>Admin Available Teachers for Archery Roster</title>
...
<div class="main">
    <h2 style="color: #008080"> Available Teachers for Archery Roster
        </h2>
        <br />
        <br />
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="row">
                <div class="col-4">
                    <asp:Button ID="Button2" class="btn btn-info ml-lg-3" runat="server" Text="Go to Archery Roster" OnClick="Button2_Click"/>  
                </div>
