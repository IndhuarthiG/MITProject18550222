<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="All notifications.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.All_notifications" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="server">
   ...
   <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource1" 
                          ...
                          SelectCommand="SELECT * FROM [Notification] ORDER BY [notifyid] DESC"></asp:SqlDataSource>
                     <div class="col">
                         <asp:GridView class="table table-striped table table-bordered" 
                             ...
                             PageSize="8">
                             <Columns>
                                 <asp:BoundField DataField="notifyid" 
                                     HeaderText="notifyid" 
                                     SortExpression="notifyid" InsertVisible="False" ReadOnly="True" Visible="False" />
