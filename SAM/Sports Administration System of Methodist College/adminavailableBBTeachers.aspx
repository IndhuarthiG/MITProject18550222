<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminavailableBBTeachers.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.adminavailableBBTeachers" %>
...
<head runat="server">
  ...
  <meta charset="utf-8"/>
  <title>Admin Available Teachers for BB Roster</title>
...
<div class="main">
    <h2 style="color: #008080"> Available Teachers for BB Roster
        </h2>
        <br />
        <br />
    <form id="form1" runat="server">
        <div class="container">
                    ...
                    <asp:TemplateField HeaderText="Status" 
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox8" 
                                runat="server" 
                                Text='<%# Bind("Status") %>' Width="150px" Height="40px" CssClass="form-control" ReadOnly="True"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <asp:Button ID="Button2" class="btn btn-info ml-lg-3" runat="server" Text="Go to BB Roster" OnClick="Button2_Click"/>  
                </div>
            </div>
            <br />
