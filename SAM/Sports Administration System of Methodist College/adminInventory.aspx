<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminInventory.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.adminInventory" %>
...
<!--Start of main content-->
    <div class="main" aria-setsize="2000">
        <h2 style="color: #008080">Inventory Table</h2>
    <br />
    <br />
    <br />
        ...
        <div class="container">
            ...
            <asp:GridView ID="GridView1" CssClass="table table-bordered table-hover" 
                ...
                GridLines="Horizontal">
                    <Columns>
                        <asp:TemplateField HeaderText="InventoryID" 
                            InsertVisible="False" 
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" 
                                    Text='<%# Bind("InventoryID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Inventory Name" 
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox1" 
                                    runat="server" 
                                    Text='<%# Bind("InventoryName") %>' Height="40" Width="150" CssClass="form-control"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Colour" 
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox2" 
                                    runat="server" 
                                    Text='<%# Bind("Colour") %>' Height="40" Width="60" CssClass="form-control"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label3" runat="server" 
                                    Text='<%# Bind("Colour") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="No in Stock" 
                            SortExpression="No_in_stock">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox3" 
                                    runat="server" 
                                    Text='<%# Bind("No_in_stock") %>' Height="40" Width="70" CssClass="form-control"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label4" runat="server" 
                                    Text='<%# Bind("No_in_stock") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Sport Name" 
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox4" 
                                    runat="server" 
                                    Text='<%# Bind("SportName") %>' Height="40" Width="150" CssClass="form-control"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton ID="btndel" runat="server" ImageUrl="~/adminimages/delete.png" Width="40" Height="40" CommandName="Delete" OnClientClick='return confirm("Delete Inventory?");' ToolTip="Delete"/>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
