<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Roster Archery.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Archery_Roster" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 style="color:#9900CC" class= "section-title">Archery Roster for the Month</h2>
            </div>
        </div>
