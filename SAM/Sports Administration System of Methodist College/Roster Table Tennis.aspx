<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Roster Table Tennis.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Table_Tennis" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 style="color:#9900CC" class= "section-title">Table Tennis Roster for the Month</h2>
            </div>
        </div>
                      ...
                      <asp:SqlDataSource ID="SqlDataSource1" 
                          ...
                          <SelectParameters>
                              <asp:QueryStringParameter DefaultValue="Table Tennis" 
                                  Name="SportName" 
                                  QueryStringField="SportName=Table Tennis" 
                                  Type="String" />
                          </SelectParameters>
                          <UpdateParameters>
                              <asp:Parameter Name="SportName" 
                         ...
                         <asp:GridView class="table table-striped table table-bordered" 
                             ...
                             <Columns>
                                 ...
                                 <asp:TemplateField HeaderText="Change">
                                     ...
                                     <ItemTemplate>
                                         <asp:LinkButton Visible='<%# CheckEnabled(Eval("EmailID").ToString(), Eval("Teacher_ID").ToString()) %>'  ID="LinkButton1" runat="server" OnCommand="LinkButton1_Click" CommandArgument='<%# Eval("ID") %>'>Send Request</asp:LinkButton>
                                     </ItemTemplate>
                                 </asp:TemplateField>
                             </Columns>
