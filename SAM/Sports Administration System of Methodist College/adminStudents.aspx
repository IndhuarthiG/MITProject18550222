<%@ Page Language="C#" AutoEventWireup="true"
    CodeBehind="adminStudents.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.adminStudents" %>
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Ad No" 
                            ...
                            <FooterTemplate>
                                ...
                                <asp:TextBox ID="txtAdNo" runat="server"
                                    Width="100" Height="40" CssClass="form-control"></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="First Name" 
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox1" 
                                    runat="server" 
                                    Text='<%# Bind("FirstName") %>' Width="200" Height="45" CssClass="form-control"></asp:TextBox>
                            ...
                            <FooterTemplate>
                                <asp:TextBox ID="txtFirstName" runat="server" Width="200" Height="40" CssClass="form-control"></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="Surname" 
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox2" 
                                    runat="server" 
                                    Text='<%# Bind("Surname") %>' Width="200" Height="45" CssClass="form-control"></asp:TextBox>
                            ...
                            <FooterTemplate>
                                <asp:TextBox ID="txtSurname" runat="server" Width="200" Height="40" CssClass="form-control"></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="Date Of Birth" 
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox3" 
                                    runat="server" 
                                    Text='<%# Bind("DateOfBirth") %>' Width="100" Height="45" CssClass="form-control" TextMode="Date"></asp:TextBox>
                                
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label4" runat="server" 
                                    Text='<%# Bind("DateOfBirth") %>'></asp:Label>
                            </ItemTemplate>
                            <FooterTemplate>
                                <asp:TextBox ID="txtDOB" runat="server" Width="100" Height="40" CssClass="form-control"></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="Email" 
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox4" 
                                    runat="server" 
                                    Text='<%# Bind("EmailID") %>' Width="200" Height="45" CssClass="form-control"></asp:TextBox>
                            ...
                            <FooterTemplate>
                                <asp:TextBox ID="txtEmail" runat="server" Width="150" Height="40" CssClass="form-control"></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="Contact No" 
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox5" 
                                    runat="server" 
                                    Text='<%# Bind("ContactNo") %>' Width="150" Height="45" CssClass="form-control"></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="Reason" 
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox6" 
                                    runat="server" 
                                    Text='<%# Bind("Reason") %>' Width="150" Height="45" CssClass="form-control"></asp:TextBox>
                                
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label7" runat="server" 
                                    Text='<%# Bind("Reason") %>'></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Description" 
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox9" 
                                    runat="server" 
                                    Text='<%# Bind("Description") %>' Width="150" Height="45" CssClass="form-control"></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="Receipt" 
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox7" 
                                    runat="server" 
                                    Text='<%# Bind("Receipt") %>' Width="150" Height="45" CssClass="form-control"></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="Date Of Registration" 
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox8" 
                                    runat="server" 
                                    Text='<%# Bind("DateOfRegistration") %>' Width="150" Height="45" CssClass="form-control"></asp:TextBox>
                                
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label9" runat="server" 
                                    Text='<%# Bind("DateOfRegistration") %>'></asp:Label>
                            </ItemTemplate>
