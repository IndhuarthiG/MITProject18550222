<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add Match.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Add_Match" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <h2 style="color: #008080">Add New Match</h2>
                        </center>
                     </div>
                  </div>
                  ...
                  <div class="row">
                      <div class="col-md-5">
                       <label style="font-family: Poppins; font-size: large; font-weight: normal;">Tournament</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server" placeholder="Tournament Name" Height="60" TextMode="SingleLine"></asp:TextBox>
                        </div>
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator1"
                                runat="server" 
                                ErrorMessage="Tournament is a required field" 
                     ...
                     <div class="col-md-2">
                        <label style="font-family: Poppins; font-size: large; font-weight: normal;">Team</label>
                        <div class="form-group">
                      ...
                      <div class="col-md-5">
                        <label style='font-family: Poppins; font-size: large; font-weight: normal;'>Opponent Team</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox8" runat="server" placeholder="Opponent Team" Height="60" TextMode="MultiLine"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3"
                                runat="server" 
                                ErrorMessage="Opponent Team is a required field" 
                   ...
                   <div class="row">
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Date" TextMode="Date" Height="60"></asp:TextBox>
                     ...
                     <div class="col-md-3">
                      ...
                      <div class="col-md-6">
                        <label style='font-family: Poppins; font-size: large; font-weight: normal;'>Venue</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox3" runat="server" placeholder="Venue" Height="60" TextMode="MultiLine"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5"
                                runat="server" 
                                ErrorMessage="Venue is a required field" 
