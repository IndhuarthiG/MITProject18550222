<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AthTeammember selection.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.AthTeammember_selection" %>
  ...
  <link rel="stylesheet" href="/resources/demos/style.css"/>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class= "section-title">Athletics Team Selection</h2>
            </div>
        </div>
   ...
   <div class="row">
       ...
       <div class="col-md-2">
           ...
           <div class="col-md-2">
                  <asp:Button ID="Button3" class="btn btn-danger ml-lg-3" runat="server" Text="View" OnClick="Button3_Click1" OnClientClick="target ='_blank';" UseSubmitBehavior="False" /> 
