<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add new Teacher.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Add_new_Teacher" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <h2 style="color: #008080">Add New Teacher</h2>
                        </center>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-md-4">
                        <label style="font-family: Poppins; font-size: large; font-weight: normal;">Teacher ID</label>
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" Height="60" width="200" placeholder="Teacher ID"></asp:TextBox>
                               <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" 
                                   runat="server" 
                                   ErrorMessage="Teacher_ID is a valid field name" 
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="First Name" Height="60"></asp:TextBox>
                        </div>
                         <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator3"
                             runat="server" 
                             ErrorMessage="First name is arequired field" 
                  ...
                  <div class="row">
                      <div class="col-md-4">
                        <label style="font-family: Poppins; font-size: large; font-weight: normal;">Surame</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox8" runat="server" placeholder="Last Name" Height="60"></asp:TextBox>
                        </div>
                      ...
                      <div class="col-md-4">
                      <label style="font-family: Poppins; font-size: large; font-weight: normal;">Email</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox13" runat="server" placeholder="E-mail" TextMode="Email" Height="60"></asp:TextBox>
                        </div>
                      ...
                      <div class="col-md-4">
                       <label style="font-family: Poppins; font-size: large; font-weight: normal;">Contact No</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox12" runat="server" placeholder="Contact No" Height="60"></asp:TextBox>
                        </div>
                   ...
                   <div class="row">
                      <div class="d-grid gap-2 col-4 mx-auto text-left">
                       ...
                       <div class="col-4">
                           <asp:Button ID="Button3" 
                             class="btn btn-info" 
                             runat="server" Text="Clear" OnClick="Button3_Click"/>
                       </div>
                    <div class="d-grid gap-2 col-4 mx-auto text-right">
                        <asp:Button ID="Button1" 
                             class="btn btn-danger" 
                             runat="server" Text="Second Sport" OnClick="Button1_Click"/>
                      </div>
