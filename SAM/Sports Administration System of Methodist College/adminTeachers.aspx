<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminTeachers.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.adminTeachers" %>
...
<div class="main">
    <h2 style="color: #008080">Teachers
        </h2>
        <br />
        <br />
            ...
            <div class="row">
                    ...
                    <div class="d-grid gap-2 col-3 mx-auto">
                        <asp:Button ID="Button2" 
                            ...
                            UseSubmitBehavior="False" OnClientClick="target ='_blank';"/>
                      </div>
                  </div>
            <br />
            <asp:GridView ID="GridView1" CssClass="table table-bordered table-hover" 
                ...
                GridLines="Horizontal">
                    <Columns>
                        <asp:TemplateField HeaderText="Teacher_ID" 
                            ...
                            <EditItemTemplate>
                                <asp:Label ID="Label1" runat="server" 
                                    Text='<%# Eval("Teacher_ID")%>'></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" 
                        ...
                        <asp:TemplateField HeaderText="Title" 
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox1" 
                                    runat="server" 
                                    Text='<%# Bind("Title")%>' Width="60" Height="40" CssClass="form-control"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="FirstName" 
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox2" 
                                    runat="server" 
                                    Text='<%# Bind("FirstName") %>' Width="200" Height="40" CssClass="form-control"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Surname" 
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox3" 
                                    runat="server" 
                                    Text='<%# Bind("Surname") %>' Width="200" Height="40" CssClass="form-control"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="ContactNo" 
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox4" 
                                    runat="server" 
                                    Text='<%# Bind("ContactNo") %>' Width="150" Height="40" CssClass="form-control"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="EmailID" 
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox5" 
                                    runat="server" 
                                    Text='<%# Bind("EmailID") %>' Height="40" Width="150" CssClass="form-control"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField ShowHeader="false">
                            <ItemTemplate>
                                <asp:ImageButton ID="btndel" runat="server" ImageUrl="~/adminimages/delete.png" Width="40" Height="40" CommandName="Delete" OnClientClick='return confirm("Delete Teacher?");' ToolTip="Delete"/>
