<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="coach view NB Participants.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.coach_view_NB_Participants" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-title">Netball Participants
                    </h2>
                </div>
            </div>
            ...
            <div class="row">
                <asp:SqlDataSource ID="SqlDataSource1"
                    ...
                    InsertCommand="INSERT INTO [Student_Sport] ([AdmissionNo], [FirstName], [Surname], [SportName], [Email]) VALUES (@AdmissionNo, @FirstName, @Surname, @Sport_Name, @Email)"
