<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminTournament.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.adminTournament" %>
...
<!--Start of main content-->
    <div class="main" aria-setsize="2000">
        <h2 style="color: #008080">Tournament Table</h2>
    <br />
    <br />
    <br />
            ...
            <asp:GridView ID="GridView1" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Year" 
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox1" 
                                runat="server" 
                                Text='<%# Bind("Year") %>' CssClass="form-control"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Sport" 
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox3" 
                                runat="server" 
                                Text='<%# Bind("SportName") %>' CssClass="form-control"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Delete">
                        <ItemTemplate>
                            <asp:ImageButton ID="Delete" runat="server" ImageUrl="~/adminimages/delete.png" Height="40" Width="40" CommandName="Delete" OnClientClick='return confirm("Delete This Tournament?");' />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
