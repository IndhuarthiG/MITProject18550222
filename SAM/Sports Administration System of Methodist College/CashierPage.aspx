<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CashierPage.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.CashierPage" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class= "section-title" style="color: #008080">Sports Registration</h2>
            </div>
        </div>
                     ...
                     <div class="card-body">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                               <asp:TextBox CssClass="form-control" ID="TextBox9" runat="server" placeholder="Enter Admission No" AutoCompleteType="Disabled"></asp:TextBox>
                         ...
                         <div class="row">
                             <div class="col-md-4">
                               ...
                               <div class="form-group">
                               <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Date Of Birth" ReadOnly="True"></asp:TextBox>
                               </div>
                             </div>
                             <div class="col-md-4">
                               <label>Email</label>
                             ...
                             <div class="col-md-4">
                               ...
                               <div class="form-group">
                               <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Contact No" TextMode="SingleLine" ReadOnly="True"></asp:TextBox>
                               </div>
                             </div>
                         ...
                         <div class="row">
                             <div class="col-md-4">
                                ...
                                Height="60px" OnSelectedIndexChanged="DropDownList3_SelectedIndexChanged1" AutoPostBack="True">
                            
                                <asp:ListItem Text="Select" Value="Select" />
                                    <asp:ListItem Text="For One Sport" Value="Rs.1000.00" />
                                    <asp:ListItem Text="For Two Sports" Value="Rs.2000.00" />
                                    <asp:ListItem Text="For Three Sports" Value="Rs.3000.00" />
                                    <asp:ListItem Text="For Four Sports" Value="Rs.4000.00" />
                            </asp:DropDownList>
                                 </div>
                             </div>
                             ...
                             <div class="d-grid gap-2 col-4 mx-auto">
                                 ...
                                 <%--<div class="d-grid gap-2 col-4 mx-auto">
                                 <asp:Button class="btn btn-danger btn-block btn-lg" ID="Button4" runat="server" Text="Send Alert" OnClick="Button4_Click" OnClientClick="target ='_blank';"/>
                             </div>--%>
