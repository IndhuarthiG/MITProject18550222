...
{
    public partial class CoachNBTeamSelection : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                dropdown();
                //BindGridview();
                string myquery = "Select * from Student_Attendance where SportName='Netball' AND Attendance= '1'";
        ...
        protected void dropdown()
        {
            ...
            SqlCommand cmd = new SqlCommand("Select Distinct Category from Student_Attendance where SportName='Netball'", con);
        ...
        protected void teamsdropdown()
        {
            ...
            SqlCommand cmd1 = new SqlCommand("select * from Teams where SportName='Netball'", con);
            // table name   
        ...
        {
            SqlConnection con = new SqlConnection(strcon);
            string myquery2 = "SELECT DISTINCT AdmissionNo, SUM(Performance) AS Total_Points FROM Student_Attendance WHERE Category LIKE '%" + DropDownList3.SelectedItem.Text + "%' AND SportName = 'Netball' GROUP BY AdmissionNo ORDER BY AdmissionNo ASC";
        ...
        protected void dropdownname()
        {
            ...
            SqlCommand cmd = new SqlCommand("Select distinct s.AdmissionNo, s.FirstName, s.Surname, DATEDIFF(YEAR, DateOfBirth, GETDATE()) AS Age From Sport_reg s INNER JOIN Student_Attendance a ON s.AdmissionNo = a.AdmissionNo Where a.SportName = 'Netball' ORDER BY AdmissionNo ASC", con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
        ...
        protected void Button2_Click(object sender, EventArgs e)//check
        {
            ...
            string myquery = "Select distinct s.AdmissionNo,s.FirstName, s.Surname, DATEDIFF(YEAR, DateOfBirth, GETDATE()) AS Age From Sport_reg s INNER JOIN Student_Attendance a ON s.AdmissionNo = a.AdmissionNo Where a.SportName = 'Netball' AND s.FirstName like '%" + DropDownList1.SelectedItem.Text + "%' AND a.Category like '%" + DropDownList3.SelectedItem.Text + "%' ORDER BY AdmissionNo ASC";
            SqlCommand cmd = new SqlCommand();
        ...
        protected void Button1_Click(object sender, EventArgs e)//display
        {
            ...
            SqlConnection con = new SqlConnection(strcon);
            string myquery = "select distinct AdmissionNo, FirstName, Surname, Category from Student_Attendance where Category like '%" + DropDownList3.SelectedItem.Text + "%' AND SportName = 'Netball'";
        ...
        //{
        //    Response.Redirect("CoachNBTeammembers");
        //}

        protected void Button3_Click1(object sender, EventArgs e)
        {
            Response.Redirect("CoachNBTeammembers.aspx");
        }
    }
}