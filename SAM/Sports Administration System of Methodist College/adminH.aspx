<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminH.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.adminH" %>
...
<div class="main">
    ...
    <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!-- Earnings (Registrations) Card Example -->
                        ...
                        <!-- Earnings (Roster Exchange) Card Example -->
                        <div class="col-xl-3 col-md-6 mb-4">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                <span class="count-name">
                                                    <a href="AdminRosterExchangeView.aspx" class="text-success">
                                                        <asp:Label ID="Label3" runat="server" Text="Roster Exchange"></asp:Label> </a>
                                                </span>
                                                </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <span class="count-numbers">
                                                    <asp:Label ID="lblros" runat="server" Text=""></asp:Label>
                                                </span>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                <span class="count-name">
                                                    <a href="UserC.aspx" class="text-purple"><asp:Label ID="Label2" runat="server" Text="Complaints"></asp:Label></a>
                                                    </span>
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                        <asp:Label ID="lblTasks" runat="server" Text=""></asp:Label>
                                                    </div>
                                                </div>
                                                <div class="col">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <span class="count-name">
                                                <a href="adminQueryview.aspx" class="text-warning"><asp:Label ID="Label1" runat="server" Text="Pending Requests"></asp:Label></a> 
                                                </span>    
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <span class="count-numbers">
                                                    <asp:Label ID="lblQuery" runat="server" Text=""></asp:Label></span>
                                            </div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Students Participation</h6>
                                        ...
                                        <ChartAreas>
                                            ...
                                            <Legends>
                                                <asp:Legend Alignment="Center" 
                                                    Docking="Bottom" Font="Poppins, 8pt" 
                                                    Name="Legend1" IsTextAutoFit="False" LegendStyle="Row">
                                                </asp:Legend>
                                            </Legends>
                                    </asp:Chart>
