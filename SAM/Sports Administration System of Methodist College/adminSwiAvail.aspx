<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminSwiAvail.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.adminSwiAvail" %>
...
<div class="main">
    <h2 style="color: #008080"> Available Teachers for Swimming Roster
        </h2>
        <br />
        <br />
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="row">
                <div class="col-4">
                    <asp:Button ID="Button2" class="btn btn-info ml-lg-3" runat="server" Text="Go to Swimming Roster" OnClick="Button2_Click"/>  
                </div>
