...
{
    public partial class coach_view_archery_Participants : System.Web.UI.Page
    {
        ...
        //        SqlCommand cmd = new SqlCommand("SELECT * FROM Student_Sport where SportName='Archery'", con);
