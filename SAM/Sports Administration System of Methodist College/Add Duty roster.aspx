<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add Duty roster.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Add_Duty_roster" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <h2 style="color: #008080">Create a Sports Duty roster</h2>
                        </center>
                     </div>
                  </div>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Date" TextMode="Date" Height="60px"></asp:TextBox>
                     ...
                     <div class="col-md-4">
                        <label style='font-family: Poppins; font-size: large; font-weight: normal;'>Time</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Time" Height="60"></asp:TextBox>
                   ...
                   <div class="row">
                       <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <asp:TextBox CssClass="form-control" ID="TextBox8" runat="server" placeholder="Teacher_ID" Height="60"></asp:TextBox>
                            <asp:LinkButton class="btn btn-secondary"
                                ID="LinkButton2" runat="server"
                                CssClass="btn-secondary" Height="60px"
                                Width="40px" OnClick="LinkButton2_Click1"> 
                                                               
                                   <center><i class="fas fa-check-circle"></i></center></asp:LinkButton>
                       ...
                       <div class="col-md-3">
                        ...
                        <div class="form-group">
                         ...
                         <asp:RequiredFieldValidator ID="RequiredFieldValidator1"
                             ...
                             ForeColor="#CC0000"></asp:RequiredFieldValidator>--%>
                            <asp:TextBox CssClass="form-control" ID="TextBox5" runat="server" placeholder="Title" Height="60"></asp:TextBox>
                     </div>
                           </div>
                       <div class="col-md-6">
                        <label style='font-family: Poppins; font-size: large; font-weight: normal;'>Surname</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox3" runat="server" placeholder="Surname" Height="60" TextMode="SingleLine"></asp:TextBox>
                   ...
                   <div class="col-md-4">
                        <label style="font-family: Poppins; font-size: large; font-weight: normal;">Status</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server" placeholder="Status" Height="60"></asp:TextBox>
                        </div>
