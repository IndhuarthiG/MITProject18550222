<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Schedule VB.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Schedule_VB" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 style="color:#339966" class= "section-title">Volleyball Schedule for the Week</h2>
            </div>
        </div>
