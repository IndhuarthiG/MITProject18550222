<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminathleticsroster.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.adminathleticsroster" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <asp:Button ID="Button2" class="btn btn-info ml-lg-3" runat="server" Text="Check" OnClick="Button2_Click1"/>  
                </div>
            </div>
