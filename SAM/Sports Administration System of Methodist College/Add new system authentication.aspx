<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add new system authentication.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Add_new_system_authentication" %>
...
<head runat="server">
  ...
  <meta charset="utf-8">
  <title>Admin Add new user login</title>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <h2 style="color: #008080">Add New Logins</h2>
                        </center>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-md-4">
                        <label style="font-family: Poppins; font-size: large; font-weight: normal;">User Name</label>
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" Height="60" width="200" placeholder="User Name"></asp:TextBox>
                               <asp:RequiredFieldValidator ID="RequiredFieldValidator1" 
                                   runat="server" 
                                   ErrorMessage="User Name is a valid field name" 
                     ...
                     <div class="col-md-4">
                        <label style="font-family: Poppins; font-size: large; font-weight: normal;">Password</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Password" Height="60"></asp:TextBox>
                        </div>
                         <asp:RequiredFieldValidator ID="RequiredFieldValidator3"
                             runat="server" 
                             ErrorMessage="Password is arequired field" 
                  ...
                  <div class="row">
                      <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox8" runat="server" placeholder="Email" Height="60" TextMode="Email"></asp:TextBox>
                        </div>
                      ...
                      <div class="col-md-4">
                      <label style="font-family: Poppins; font-size: large; font-weight: normal;">Name</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox13" runat="server" placeholder="Name" TextMode="SingleLine" Height="60"></asp:TextBox>
                        </div>
