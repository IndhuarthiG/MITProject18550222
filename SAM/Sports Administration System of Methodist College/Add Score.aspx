<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add Score.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Add_Score" %>
...
<head runat="server">
  ...
  <meta charset="utf-8">
  <title>Admin Add New Match Score</title>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <h2 style="color: #008080">Add New Match Score</h2>
                        </center>
                     </div>
                  </div>
                  ...
                  <div class="row">
                   ...
                   <div class="row">
                     ...
                     <div class="col-md-4">
                        <label style='font-family: Poppins; font-size: large; font-weight: normal;'>Score</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Score" Height="60"></asp:TextBox>
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox3" runat="server" placeholder="Status" Height="60" TextMode="MultiLine"></asp:TextBox>
