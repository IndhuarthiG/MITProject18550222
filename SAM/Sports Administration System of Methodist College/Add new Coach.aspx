<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add new Coach.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Add_new_Coach" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <h2 style="color: #008080">Add New Coach</h2>
                        </center>
                     </div>
                  </div>
                  ...
                  <div class="row">
                      <div class="col-md-2">
                        <label style="font-family: Poppins; font-size: large; font-weight: normal;">Coach_ID</label>
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Coach ID"></asp:TextBox>
                               <asp:RequiredFieldValidator ID="RequiredFieldValidator8"
                                   runat="server" 
                                   ErrorMessage="Coach ID is a required field" 
                     ...
                     <div class="col-md-4">
                        <label style='font-family: Poppins; font-size: large'>First Name</label>
                        <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <label style='font-family: Poppins; font-size: large'>Surname</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox8" runat="server" placeholder="Surname" Height="60"></asp:TextBox>
                ...
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DropDownList2" runat="server" Height="60">
                                    <asp:ListItem Text="Select" Value="Select" />
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4"
                                runat="server" 
                                ErrorMessage="Type is a valid field name" 
                                ControlToValidate="DropDownList1" 
                                ForeColor="#CC0000"></asp:RequiredFieldValidator>
                        </div>
                     </div>
                   ...
                   <div class="col-md-3">
                        <label style='font-family: Poppins; font-size: large'>Contact No</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox12" runat="server" placeholder="Contact No"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5"
                                runat="server" 
                                ErrorMessage="Contact No is a reuired field" 
                                ControlToValidate="TextBox12" 
                                ForeColor="#CC0000"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="col-md-4">
                       <label style='font-family: Poppins; font-size: large'>Email</label>
                        <div class="form-group">
