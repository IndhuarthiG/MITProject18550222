<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminStudentcompleteview.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.adminStudentcompleteview" %>
...
<div class="main">
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <br />
            <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover" Width="1000px" PageSize="10" 
                    BackColor="White" BorderColor="#336666" 
                    BorderStyle="Double" BorderWidth="3px" 
                    CellPadding="4" 
                GridLines="Horizontal" OnPageIndexChanging="GridView1_PageIndexChanging" OnSorting="GridView1_Sorting" AllowSorting="true">
