<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add new student.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Add_new_student" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <h2 style="color: #008080">Add New Student</h2>
                        </center>
                     </div>
                  </div>
                     ...
                     <div class="col-md-3">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Admission No"></asp:TextBox>
                ...
                <div class="row">
                    <div class="col-md-3">
                      <label style='font-family: Poppins; font-size: large'>Date Of Birth</label>
                      <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox5" runat="server" placeholder="Date" Height="60" TextMode="Date"></asp:TextBox>
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator4"
                              runat="server"
                               ErrorMessage="Class is a required field" 
