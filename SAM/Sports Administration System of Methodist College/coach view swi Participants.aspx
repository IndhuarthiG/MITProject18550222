<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="coach view swi Participants.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.coach_view_swi_Participants" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-title">Swimming Participants
                    </h2>
                </div>
            </div>
                ...
                <div class="col-10">
                    ...
                    <div class="mb-3">
                        <asp:TextBox CssClass="form-control" ID="TextBox1"
                            runat="server" placeholder="Receivers Email" Enabled="True"></asp:TextBox>
                    </div>
