<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add new Team member.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Add_new_Team_member" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <h2 style="color: #008080">Add New Team Member</h2>
                        </center>
                     </div>
                  </div>
                      ...
                      <div class="col-md-2">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Admission No" Height="60px"></asp:TextBox>
