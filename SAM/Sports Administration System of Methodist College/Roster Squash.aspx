<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Roster Squash.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Squash_Roster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="server">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 style="color:#9900CC" class= "section-title">Squash Roster for the Month</h2>
            </div>
        </div>
   ...
   <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource1" 
                          ...
                          <SelectParameters>
                              <asp:QueryStringParameter DefaultValue="Squash" 
                                  Name="SportName" 
                                  QueryStringField="SportName=Squash" 
                                  Type="String" />
                          </SelectParameters>
                          <UpdateParameters>
                              <asp:Parameter Name="SportName" 
