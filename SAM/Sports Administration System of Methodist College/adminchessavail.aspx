<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminchessavail.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.adminchessavail" %>
...
<div class="main">
    <h2 style="color: #008080"> Available Teachers for Chess Roster
        </h2>
        <br />
        <br />
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="row">
                <div class="col-4">
                    <asp:Button ID="Button2" class="btn btn-info ml-lg-3" runat="server" Text="Go to Chess Roster" OnClick="Button2_Click"/>  
                </div>
