...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminTeam admission.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.adminTeam_admission" %>
...
<head runat="server">
  ...
  <meta charset="utf-8">
  <title>Admin Team Admission</title>
...
<!--Start of main content-->
    <div class="main" aria-setsize="2000">
        <h2 style="color: #008080">Team Member Table</h2>
    <br />
    <br />
    <br />
                ...
                <Columns>
                    <asp:TemplateField HeaderText="AdmissionNo" 
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox1" 
                                runat="server" 
                                Text='<%# Bind("AdmissionNo") %>' Width="150" ReadOnly="True"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="FirstName" 
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox2" 
                                runat="server" 
                                Text='<%# Bind("FirstName") %>' Width="200" ReadOnly="True"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Surname" 
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox3" 
                                runat="server" 
                                Text='<%# Bind("Surname") %>' Width="200" ReadOnly="True"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Team Name" 
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox5" 
                                runat="server" 
                                Text='<%# Bind("TeamName") %>' Width="150" ReadOnly="True"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Position" 
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox6" 
                                runat="server" 
                                Text='<%# Bind("Position") %>' Width="150"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Delete">
                        <ItemTemplate>
                            <asp:ImageButton ID="Delete" runat="server" ImageUrl="~/adminimages/delete.png" Height="40" Width="40" CommandName="Delete" OnClientClick='return confirm("Delete Team member");' />
                        </ItemTemplate>
