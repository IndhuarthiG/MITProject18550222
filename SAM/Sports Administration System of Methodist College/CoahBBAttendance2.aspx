<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CoahBBAttendance2.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.CoahBBAttendance2" %>
   ...
   <div class="row">
       ...
       <br />
        ...
        <div class="row">
            ...
            <div class="col-4">
                    <asp:Button ID="Button3" class="btn btn-danger ml-lg-3" runat="server" Text="View" OnClick="Button3_Click" OnClientClick="target ='_blank';"/>  
