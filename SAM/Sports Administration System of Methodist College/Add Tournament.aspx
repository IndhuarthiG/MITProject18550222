<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add Tournament.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Add_Tournament" %>
...
<head runat="server">
  ...
  <meta charset="utf-8">
  <title>Admin Add Tournament</title>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <h2 style="color: #008080">Add New Tournament</h2>
                        </center>
                     </div>
                  </div>
                  ...
                  <div class="row">
                      <div class="col-md-2">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Year"></asp:TextBox>
                               <asp:RequiredFieldValidator ID="RequiredFieldValidator8"
                                   runat="server" 
                                   ErrorMessage="Year is a required field" 
                     ...
                     <div class="col-md-4">
                        <label style='font-family: Poppins; font-size: large; font-weight: normal;'>Tournament Name</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Tournament Name" Height="60"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2"
                                runat="server" 
                                ErrorMessage="Tournament Name is a required field" 
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox8" runat="server" placeholder="Description" Height="60" TextMode="MultiLine"></asp:TextBox>
