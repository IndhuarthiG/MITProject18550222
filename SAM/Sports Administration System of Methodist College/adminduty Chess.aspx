<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminduty Chess.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.adminduty_Chess" %>
...
<head runat="server">
  ...
  <meta charset="utf-8"/>
  <title>Admin Assign Teachers to Sports</title>
...
<div class="main">
    <h2 style="color: #008080"> Teachers on Chess Duty
        </h2>
        <br />
        <br />
    <form id="form1" runat="server">
        <div class="container">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Delete">
                        <ItemTemplate>
                            ...
                            <asp:ImageButton ID="Delete" runat="server" ImageUrl="~/adminimages/delete.png" Height="40" Width="40" CommandName="Delete" OnClientClick='return confirm("Delete Teacher");' />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" 
                ...
                DeleteCommand="DELETE FROM [Teacher_Sport] WHERE [ID] = @original_ID AND [Teacher_ID] = @original_Teacher_ID AND [Title] = @original_Title AND [FirstName] = @original_FirstName AND [Surname] = @original_Surname" 
                InsertCommand="INSERT INTO [Teacher_Sport] ([Teacher_ID], [Title], [FirstName], [Surname]) VALUES (@Teacher_ID, @Title, @FirstName, @Surname)" 
                OldValuesParameterFormatString="original_{0}" 
                SelectCommand="SELECT [ID], [Teacher_ID], [Title], [FirstName], [Surname] FROM [Teacher_Sport] WHERE ([Sport_Name] = @Sport_Name)" 
                
                
                
                UpdateCommand="UPDATE [Teacher_Sport] SET [Teacher_ID] = @Teacher_ID, [Title] = @Title, [FirstName] = @FirstName, [Surname] = @Surname WHERE [ID] = @original_ID AND [Teacher_ID] = @original_Teacher_ID AND [Title] = @original_Title AND [FirstName] = @original_FirstName AND [Surname] = @original_Surname">
                <DeleteParameters>
