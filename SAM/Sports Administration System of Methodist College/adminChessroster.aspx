<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminChessroster.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.adminChessroster" %>
...
<head runat="server">
  ...
  <meta charset="utf-8"/>
  <title>Admin Chess Roster</title>
...
<div class="main">
    <h2 style="color: #008080"> Chess Roster
        </h2>
        <br />
        <br />
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="row">
                <div class="col-4">
                    <asp:Button ID="btnSendMail" class="btn btn-primary ml-lg-3 alert-success" runat="server" Text="Roster Alerts" OnClick="btnSendMail_Click" UseSubmitBehavior="False" OnClientClick="this.disabled='true'; this.value='Please wait....';"/>  
                </div>
                <div class="col-4">
