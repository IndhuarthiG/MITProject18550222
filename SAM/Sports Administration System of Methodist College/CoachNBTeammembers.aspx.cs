...
{
    public partial class CoachNBTeammembers : System.Web.UI.Page
    {
        ...
        private void GetData(string dropdownText = "")
        {
            ...
            {
                qry = "Select * from Student_Team where TeamName= 'NBU18' OR TeamName = 'NBU16' OR TeamName = 'NBU14' OR TeamName = 'NBU12' OR TeamName = 'NBU20'";
            }
            else
            {
        ...
        protected void teamname()
        {
            ...
            SqlCommand cmd1 = new SqlCommand("Select Distinct TeamName from Student_Team where TeamName= 'NBU18' OR TeamName = 'NBU16' OR TeamName = 'NBU14' OR TeamName = 'NBU12' OR TeamName = 'NBU20'", con);
            // table name   
