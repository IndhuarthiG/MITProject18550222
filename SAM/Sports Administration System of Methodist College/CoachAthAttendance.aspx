<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CoachAthAttendance.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.CoachAthAttendance" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class= "section-title">Athletics Attendance</h2>
            </div>
        </div>
        ...
        <div class="row">
           ...
           <div class="col-md-4">
                               ...
                               <asp:DropDownList ID="DropDownList2" runat="server" CssClass="form-control">
                                    ...
                                    <asp:ListItem Text="Sprinting" Value="Sprinting"/>
                                    <asp:ListItem Text="Relay" Value="Relay"/>
                                    <asp:ListItem Text="Hurdles" Value="Hurdles"/>
                                    <asp:ListItem Text="Long jump" Value="Long jump"/>
                                    <asp:ListItem Text="High jump" Value="High jump"/>
                                   <asp:ListItem Text="Shot put" Value="Shot put"/>
                                   <asp:ListItem Text="Javelin" Value="Javelin"/>
                                   <asp:ListItem Text="Discuss" Value="Discuss"/>
                                   <asp:ListItem Text="Triple jump" Value="Triple jump"/>
                                         </asp:DropDownList>
