...
{
    public partial class Squash_Roster : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from Rosters where Teacher_ID='" + Session["UserName"].ToString() + "' AND SportName='Squash'", con);
        ...
        protected bool CheckEnabled(String _email, String _teacherID)
        {
            ...
            SqlCommand cmd = new SqlCommand("select count(*) from Rosters where Teacher_ID='" + _teacherID + "' AND SportName='Squash' AND Requests!=''", con);
