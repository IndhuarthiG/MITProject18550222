...
{
    public partial class Team_member_selection : System.Web.UI.Page
    {
        ...
        protected void GridView2_Sorting(object sender, GridViewSortEventArgs e)//sort for G2
        {
        ...
        protected void GridView1_Sorting(object sender, GridViewSortEventArgs e)//sort for G1
        {
            DataTable result = (DataTable)ViewState["dt"];
        ...
        {
            Response.Redirect("CoachBBteammembers.aspx");
        }
        ...
        protected void dropdownname()
        {
            ...
            SqlCommand cmd = new SqlCommand("Select distinct s.AdmissionNo, s.FirstName, s.Surname, DATEDIFF(YEAR, DateOfBirth, GETDATE()) AS Age From Sport_reg s INNER JOIN Student_Attendance a ON s.AdmissionNo = a.AdmissionNo Where a.SportName = 'Basketball' ORDER BY AdmissionNo ASC", con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
        ...
        protected void Button2_Click(object sender, EventArgs e)//Check 
        {
            ...
            string myquery = "Select distinct s.AdmissionNo,s.FirstName, s.Surname, DATEDIFF(YEAR, DateOfBirth, GETDATE()) AS Age From Sport_reg s INNER JOIN Student_Attendance a ON s.AdmissionNo = a.AdmissionNo Where a.SportName = 'Basketball' AND s.FirstName like '%" + DropDownList1.SelectedItem.Text + "%' AND a.Category like '%" + DropDownList3.SelectedItem.Text + "%' ORDER BY AdmissionNo ASC";
            SqlCommand cmd = new SqlCommand();
