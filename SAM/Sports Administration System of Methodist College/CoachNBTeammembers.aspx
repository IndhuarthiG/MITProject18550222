<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CoachNBTeammembers.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.CoachNBTeammembers" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class= "section-title">Netball Team Members</h2>
            </div>
        </div>
       <br />
        <div class ="row">
