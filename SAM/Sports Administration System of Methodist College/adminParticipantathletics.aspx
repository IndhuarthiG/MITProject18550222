<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminParticipantathletics.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.adminParticipantathletics" %>
...
<head runat="server">
  ...
  <meta charset="utf-8"/>
  <title>Admin Athletics Participants</title>
...
<div class="main">
    <h2 style="color: #008080"> Athletics Participants
        </h2>
        <br />
        <br />
        ...
        <div class="container">
           ...
           <asp:GridView ID="GridView1" 
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <asp:Button ID="Button1" class="btn btn-danger ml-lg-3" runat="server" Text="Cancel Alert" OnClick="Button1_Click1"/>  
                </div>
            </div>
            <%--<div class="row">
                <div class="col-10">
