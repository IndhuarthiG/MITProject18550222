<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add new Sports.aspx.cs" Inherits="Sports_Administration_System_of_Methodist_College.Add_new_Sports" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <h2 style="color: #008080">Sports Management</h2>
                        </center>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <%--<div class="col-md-5">
                        <label style="font-family: Poppins; font-size: large; font-weight: normal;">Sport ID</label>
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Sport ID" Height="60" ReadOnly="True"></asp:TextBox>
                                 </div>
                        </div>
                     </div>--%>
                     <div class="col-md-7">
                        <label style="font-family: Poppins; font-size: large; font-weight: normal;">Name of Sport</label>
                        <div class="form-group">
                            <asp:TextBox CssClass="form-control" ID="TextBox12" runat="server" placeholder="Name of Sport" Height="60"></asp:TextBox>
                        </div>
                     </div>
                ...
                <br />
                  <div class="row">
                     ...
                     <div class="d-grid gap-2 col-4 mx-auto">
                        <%--<asp:Button ID="Button2" class="btn btn-lg btn-danger" runat="server" Text="Delete" />--%>
                     </div>
                  </div>
